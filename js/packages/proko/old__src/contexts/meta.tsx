...
import { Connection, PublicKey, PublicKeyAndAccount, Transaction, TransactionInstruction } from '@solana/web3.js';
      ...
      const processMetaplexAccounts = async (
        ...
        try {
          if (a.account.data[0] === MetaplexKey.AuctionManagerV1) {
            ...
            const ticket = await decodePayoutTicket(a.account.data);
